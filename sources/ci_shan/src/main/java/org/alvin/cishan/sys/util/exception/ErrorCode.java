...
//    int ENOTSUPPORTED = -1002;
    ...
    int BRANCH_GROUP_EXITS = -11001;//组名称已经存在
    int BRANCH_UNKNOWN_LOCATION = -11002;//无法正确的获取位置信息

    int EPHONEEXIST = -11003; //手机号已经存在

    //token 安全认证失败
    int TOKEN_INVALID = -80000;
    //强制更新版本
    int MUST_UPDATE = -80001;
    //有新版本
    int HAS_UPDATE = -80002;
}
