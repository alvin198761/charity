...
public class CharityEventDao extends BaseDao {
	...
	public Page<CharityEvent> queryPage(CharityEventCond cond) {
		...
		sb.append(" FROM charity_event t ");
	...
	public String getSelectedItems(CharityEventCond cond) {
		if (cond == null || cond.getSelectedFields() == null || cond.getSelectedFields().isEmpty()) {
			...
			sb.append(" t.id,t.type,t.name,t.content,t.chairman_id,t.target_id,t.event_time,t.author,t.remark,t.chairmain_pnone,t.target_phone,t.status,t.create_time, "); //默认所有字段
			sb.append(" td.`name` as type_name,ca.charity_name as charity_name,cb.charity_name as target_name,u.`name` as user_name ");
			return sb.toString();
		}
	...
	public String getJoinTables() {
		...
		sb.append(" LEFT JOIN charity ca on t.chairman_id = ca.id  and ca.category = 1 ");
		sb.append(" LEFT JOIN charity cb on t.target_id = cb.id and cb.category = 2 ");
