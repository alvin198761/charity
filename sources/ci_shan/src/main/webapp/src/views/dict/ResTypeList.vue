    ...
    <div>
        <!--<el-form line="true">-->
            <!--<el-form-item label="名称">-->
                <!--<el-input placeholder="物资类型名称" size="small" v-model="form.name"></el-input>-->
            <!--</el-form-item>-->
            <!--<el-form-item>-->
        ...
        <el-table :data="dataList" v-loading="loading" element-loading-text="正在加载......" style="width: 100%">
            ...
            <el-table-column prop="name" label="物资类型名称"></el-table-column>
            <el-table-column label="操作" width="150">
                <template slot-scope="props">
                    <div>                        <el-button type="text" @click="doEdit(props.row)">编辑</el-button>
                        <!--<el-button type="text" @click="doDelete(props.row)">删除</el-button>-->
                    </div>
                </template>
            </el-table-column>
        </el-table>
        <DictDialog ref="dialog" :refresh="refresh" :type="form.type" titleName="物资类型"></DictDialog>
    </div>
</template>
<script>
