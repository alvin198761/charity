    ...
    <div>
        <el-form :inline="true">
            <el-form-item label="名称">
                <el-input placeholder="行善方类型名称" size="small" v-model="form.name"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <el-table :data="dataList" v-loading="loading" element-loading-text="正在加载......" style="width: 100%">
            ...
            <el-table-column prop="name" label="行善方类型名称"></el-table-column>
        ...
        <DictDialog ref="dialog" :refresh="refresh" :type="form.type" titleName="行善方类型"></DictDialog>
    </div>
</template>
<script>
...
//                    that.$message.error("获取行善方类型失败：" + res);
                    that.loading = false;
                });
            },
            doAdd() {
