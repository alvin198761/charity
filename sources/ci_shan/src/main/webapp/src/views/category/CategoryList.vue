...
<template>
      <div><h3>捐助物资</h3>
            ...
            <el-form :inline="true">
                        ...
                        <el-input placeholder="请输入count" size="small" v-model="form.count"></el-input>
                    </el-form-item>
                        ...
                        <el-input placeholder="请输入remark" size="small" v-model="form.remark"></el-input>
                                    ...
                                    <el-form-item label="c_id">
                        <el-input placeholder="请输入c_id" size="small" v-model="form.c_id"></el-input>
                    </el-form-item>
                            ...
                            <el-form>
                                  <el-row :gutter="10">
                                              ...
                                              <el-form-item label="name">{{props.row.name}}</el-form-item>
                                                                                ...
                                                                                <el-col :span="6">
                                              <el-form-item label="count">{{props.row.count}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              ...
                                              <el-form-item label="remark">{{props.row.remark}}</el-form-item>
                                                                                ...
                                                                                <el-col :span="6">
                                              <el-form-item label="c_id">{{props.row.c_id}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                    ...
                                    <el-table-column prop="c_id" label="c_id"></el-table-column>
